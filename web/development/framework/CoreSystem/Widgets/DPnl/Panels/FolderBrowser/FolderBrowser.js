					  ...
					  Description)
{
	...
	fMnu.Add(new MenuItem("Share...", "/graphics/folder_user.png", ""));
	fMnu.Add(new MenuItem("Create Jumper Link", "/graphics/folder_link.png", ""));
	fMnu.Add(new MenuItem("Move to Trash Can", "/graphics/bin.png", ""));
	
	fMnu.Add(new MenuItem("-", "", ""));
	fMnu.Add(new MenuItem("Properties...", "/graphics/application_form.png", ""));
	fMnu.Generate();
	NormalCursor();
...
function DoAction(Action, URL) 
{
	...
	try {
		...
		myAB.Show();
		soundManager.play('SYSTEM_WARNING');
	}
