...
DPnl.prototype.Show = function () {
	try {
			...
			var DPnl_MessageHandler  = function (handle, msgid, sender, msg) {
				switch (msgid) {
					case IWC_WINDOWGEOMETRYCHANGED:
						...
						var TitlePanel = new PElement(BaseHandle + "_Title_" + PanelID);
						...
						var MainPanelWidth = msg.width - 200;
						
						var LeftPanelHeight = msg.height;
						var LeftPanelWidth = 200;
						
						
						LeftPanel.Resize(new PRect(0, 0, LeftPanelWidth, LeftPanelHeight - 21));
						MainPanel.Resize(new PRect(0, 0, MainPanelWidth - 27, MainPanelHeight - 39));
		...
		AjaxGetElementReference('SysWidget_DPnl_Title_' + this.PanelID).innerHTML = TitleContent;
