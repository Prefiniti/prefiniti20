...
function KSynchronousRequest(BaseURL, RequestHeaders)
{
    ...
    try {
		...
		kab = new AlertBox("Network Failure<br><br>Please check your computer's Internet connection and try again", "Network Failure", "/graphics/AppIconResources/crystal_project/32x32/devices/socket.png");
		kab.Show();
	}
...
{
	var ciab = new AlertBox("Instance Name: " + I_Name + "<br>Instance Mode: " + I_Mode + "<br>Bytes Transferred: " + BytesTransferred + "<br><br>Host Browser: " + HP_Browser + "<br>Host OS: " + HP_OS, "Connection Info", "/graphics/AppIconResources/crystal_project/32x32/apps/knetconfig.png");
	ciab.Show();
}
