...
<div style="height:100%; width:100%;" class="__PREFINITI_APPLICATION">
	...
	<hr />
		...
		<span class="__PREFINITI_TAB_ACTIVE" style="height:25px; width:auto;" id="tab_friends"><img src="/graphics/group.png" align="absmiddle" /> <a href="##" onclick="LoadFriends();">Friends</a> <select size="1" name="upf" id="upf" style="width:50px;" onclick="LoadFriends();"><option value="all" selected>All</option></select>
		</span>
		</cfif>
		<cfif URL.ShowCoworkers EQ true>
    	<span class="__PREFINITI_TAB_INACTIVE" style="height:25px; color:black; width:auto;" id="tab_coworkers"><img src="/graphics/building.png" align="absmiddle"/> <a href="##" onclick="LoadCoworkers(GetValue('UPCowork'));">Coworkers</a>
		...
		<span class="__PREFINITI_TAB_INACTIVE" style="height:25px;  width:auto;" id="tab_customers"><img src="/graphics/money.png" align="absmiddle" /> <a href="##" onclick="LoadCustomers(GetValue('UPCust'));">Customers</a>
		...
		<span class="__PREFINITI_TAB_INACTIVE" style="height:25px; width:auto;" id="tab_search"><img src="/graphics/zoom.png" align="absmiddle" /> <a href="####" onclick="LoadSearch();">Search</a> <select size="1" name="ups" id="ups" onclick="LoadSearch();" style="width:50px;"><option value="all" selected>All</option></select></span>
		</cfif>
		<br />
