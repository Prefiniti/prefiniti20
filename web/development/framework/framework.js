...
function AjaxLoadPageToDiv(DivID, PageURL, onTransferCompleted, onTransferStart, onTransferProgress, onTransferError)
{
	...
	if(PageURL.indexOf('LoaderUniqueValue') == -1) {
		PageURL += "&LoaderUniqueValue=" + escape(LoaderUniqueValue);
	}
	...
	xmlHttp.onreadystatechange = function()
	{
		switch(xmlHttp.readyState) {
			case 4:
				...
				if (DivID == 'tcTarget') {
					FWAdd = '<p style="font-size:8px; color:#999999;">Prefiniti Application Framework ' + FrameworkRevision + '<br>Copyright &copy; 2008 Prefiniti Inc.<br>Patent Pending.</p>';
				} 
				else {
					FWAdd = '';
				}
