<cfquery name="accountInfo" datasource="#session.DB_Core#">
	SELECT * FROM Users WHERE id=#URL.id#
</cfquery>

<cfquery name="getCompanies" datasource="#session.DB_Core#">
	SELECT * FROM companies ORDER BY name
</cfquery>

<cfquery name="getCompanyName" datasource="#session.DB_Core#">
