...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td valign="top">
			...
			<cfmodule template="/framework/link.cfm" perm="WW_MANAGECATALOG" linkname="Add a product to my company's catalog" url="AddProduct" help="Add Product"><br />
            <cfmodule template="/framework/link.cfm" perm="NF_MANAGE" linkname="Manage News Feeds" url="ManageNewsFeeds" help="Manage News Feeds"><br />
			</p>				
