...
<cffunction name="wwReadConfig" returntype="string" output="no">
	...
	<cfelse>
    	<cfquery name="wwrc_default" datasource="#session.DB_Core#">
        	SELECT * FROM configuration_defaults WHERE conf_key='#conf_key#'
        </cfquery>
        
        <cfif wwrc_default.RecordCount GT 0>
        	<cfreturn wwrc_default.default_value>
		<cfelse>            
...
<cffunction name="CreateSiteEx" returntype="numeric" output="no">
	<cfargument name="SiteName" type="string" required="yes">
    <cfargument name="enabled" type="boolean" required="yes">
    <cfargument name="summary" type="string" required="yes">
    <cfargument name="about" type="string" required="yes">
    <cfargument name="industry" type="numeric" required="yes">
    <cfargument name="mission_statement" type="string" required="yes">
    <cfargument name="vision_statement" type="string" required="yes">
    <cfargument name="slogan" type="string" required="yes">
    <cfargument name="billing_plan" type="numeric" required="yes">
    <cfargument name="salestax_rate" type="numeric" required="yes">
    <cfargument name="region" type="numeric" required="yes">
    <cfargument name="location" type="numeric" required="yes">
  <!---  
    <cfquery name="CreateSiteEx" datasource="#session.DB_Sites#">
   		INSERT--->
</cffunction>
...
<cffunction name="RegisterAccount" returntype="numeric" output="no">
	...
	<cfargument name="Phone" type="string" required="no" default="5551212">
	<cfargument name="CarrierSuffix" type="string" required="no" default="">
    ...
    <cfquery name="MakeCashPP" datasource="#session.DB_Core#">
