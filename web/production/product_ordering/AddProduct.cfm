...
<h3>Add Product -<cfmodule template="/authentication/components/siteNameByID.cfm" id="#URL.SiteID#"></h3>

<cfoutput>
<form name="AddProductFm" id="AddProductFm">
	<input type="hidden" name="site_id" value="#url.SiteID#" id="site_id" />
	<input type="hidden" name="user_id" value="#url.UserID#" id="user_id" />
    <table width="100%">
	<tr>
		<td>Product Name:</td>
