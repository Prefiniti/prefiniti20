...
<cfquery name="getCusts" datasource="#session.DB_Sites#">
...
<form name="reqJob" action="job-submit.cfm" method="post" name="SurveyOrderForm" id="SurveyOrderForm">
	...
	<select name="custs" id="custs" onchange="SetValue('clientID', GetValue('custs'))" <cfif URL.PermissionLevel EQ 0>disabled</cfif>>
