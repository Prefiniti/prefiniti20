...
<cfoutput>
	<div class="FolderButton" style="border-bottom:none; #NoB#">
			<table width="100%">
			<tr><td width="16" align="left" style="background-color:white; color:black;" valign="middle"><img src="#Thumb(FIcon, 16, 16)#" align="absmiddle" onmouseover="Tip('#FDir#');" align="absmiddle" onmouseout="UnTip();" /></td>
			<td align="left" style="background-color:white; color:black;" valign="middle"><a href="####" onclick="BrowseFrom('#BaseURL#', '#URL.View#');">#FName#</a></td>
			</tr></table>
	</div>
</cfoutput>