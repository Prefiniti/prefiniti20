...
<cfif BitAnd(URL.Style, 64)> 		<!--- WS_ROOT --->
	...
	<div id="#URL.Handle#_ToolbarStrip" style="width:100%; height:30px;"></div>
	<div id="#URL.Handle#_DesktopFolder" style="width:#URL.Width#px; height:#URL.Height#px;"></div>
	<div id="#URL.Handle#_InnerFrame"></div>
    
<cfelse>							<!--- CHILD WINDOW --->
<cfif BitAnd(URL.Style, 2048)>
	<div style="-moz-border-radius:10px; padding:10px; width:auto; height:auto; background-color:black; color:white;">
        <div id="#URL.Handle#_ClientArea"  style="width:#URL.Width#px; height:#URL.Height#px; overflow:hidden;">
...
<cfelse>                    
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tr>
			<td align="left" class="__PREFINITI_TLC"id="__PREFINITI_TLC_#URL.Handle#" style="background-position:right;"><!--- TLC ---><div style="width:8px;"></div></td>
			...
			<div id="#URL.Handle#_titlex" 
				...
				<div style="padding-top:8px; padding-left:8px;">
					<strong id="#URL.Handle#_TitleText" class="__PREFINITI_TITLETEXT">#URL.Title#</strong>
				</div>
			</div>
			</td>
			<td 
		...
		<tr>
			...
			<td id="__PREFINITI_LEFTEDGE_#URL.Handle#" onclick="p_session.Framework.SetFocus('#URL.Handle#');"  class="#LeftEdgeClass#" style="background-color:transparent; background-position:right;">
			<!--- LEFTEDGE--->&nbsp;<div style="width:8px;"></div></td>
			<td colspan="3" style="background-color:white; border:none;" >
				
				
				<!--- INNERFRAME --->
				<div id="#URL.Handle#_InnerFrame" class="__PREFINITI_INNERFRAME" style="width:auto; height:auto;">
		...
		<tr>
			...
			<td  id="__PREFINITI_BOTTOMEDGE_#URL.Handle#"
			<cfif BitAnd(URL.Style, 8)>
			...
			<td align="right" class="#BRCSTYLE#" <cfif BitAnd(URL.Style, 8)>onmousedown="p_session.Framework.PResizeWindow('#URL.Handle#', event);"</cfif> valign="bottom" style="background-color:transparent; background-position:top left;"><!--- BRC --->	
