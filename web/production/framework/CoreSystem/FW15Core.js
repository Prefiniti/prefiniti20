var ClassicReady = "UNLOADED";
writeConsole("Legacy support loadable and available in all instance modes.");
...
{
		showDivBlock('CLoader');
	
		loadjscssfile('/contentManager/contentManager.js', 'js');
		lp(1);
		loadjscssfile('/mapping/mapping.js', 'js');
		lp(2);
		loadjscssfile('/contentmanager/swfupload.js', 'js');
		lp(3);
		loadjscssfile('/Framework/CoreSystem/Widgets/DPnl/Panels/FolderBrowser/SWFUploadHandlers.js', 'js');
		lp(4);
		lp(5);
		loadjscssfile('/authentication/authentication.js', 'js');
		lp(6);
		loadjscssfile('/socialnet/socialnet.js', 'js');
		lp(7);
		loadjscssfile('/mail/mail.js', 'js');
		lp(8);
		loadjscssfile('/workflow/projects.js', 'js');
		lp(9);
		loadjscssfile('/tc/timecard.js', 'js');
		lp(10);
		loadjscssfile('/scheduling/scheduling.js', 'js');
		lp(11);
		loadjscssfile('/news/news.js', 'js');
		lp(12);
		loadjscssfile('/legalsection/legalsection.js', 'js');
		lp(13);
		loadjscssfile('/help/help.js', 'js');
		lp(14);
		loadjscssfile('/MyCL/components/collapse.js', 'js');
		lp(15);
		loadjscssfile('/controls/record_scroller.js', 'js');
		lp(16);
		loadjscssfile('/controls/date_picker.js', 'js');
		lp(17);
		loadjscssfile('/notifications/notifications.js', 'js');
		lp(18);
...
function lp(val) 
{
	...
	var le = AjaxGetElementReference("CLoad_" + val.toString());
	le.style.backgroundColor = "#EFEFEF";
