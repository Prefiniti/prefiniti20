...
<div style="height:100%; width:100%;" class="__PREFINITI_APPLICATION">
	...
	<table width="100%">	
    	...
    	<input type="hidden" id="DefaultRunLevel" value="3" />
        <input type="hidden" id="BootTimeout" value="10" />
<!---		<tr>
		...
		<tr>
			<td colspan="2" align="right">
				...
				<input type="button" value="Save and Close" class="normalButton" onclick="AjaxSubmitForm(AjaxGetElementReference('hostinfo'), '/Framework/CoreSystem/HTMLResources/WriteHost.cfm', 'hostcfg'); p_session.Framework.PostLocalMessage('RegisterHost', IWC_REQUESTCLOSE, C_WINDOWMANAGER, null);">
			</td>
		</tr>
	</table>
	</form>
