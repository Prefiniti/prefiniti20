					...
					<tr>
						...
						<cfif available EQ 1>
							...
							<cfelse>
                                ...
                                <cfmodule template="/Framework/CoreSystem/Widgets/ShoppingCart/GetCustomizations.cfm" ProductName="#ProductName#" ProductID="#id#"><Br /><br />
                                
                                <img src="/graphics/cart_add.png" align="absmiddle" /> Quantity <input type="text" id="PCQuanF_#id#" name="PCQuanF_#id#" style="width:32px;" /><input type="button" class="normalButton" onclick="AddToCart(#id#, GetValue('PCQuanF_#id#'), PGetCustomizations(#id#));" value="Add to Cart" />
					...
					<cfif getPermissionByKey("WW_MANAGECATALOG", url.current_association)>
						...
						<tr>
							<td style="background-color:##EFEFEF; padding-left:10px;">
								...
								<img src="/graphics/cart_add.png" align="absmiddle"> <a href="####" onclick="AddProduct(#site_id#)">Add a new product...</a>
							</td>
						</tr>
						</table>
					</cfif>
