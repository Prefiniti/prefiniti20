...
<div style="width:100%; height:100%;" class="__PREFINITI_APPLICATION">
	<div style="padding:30px;">
		<img src="/graphics/application_error.png" align="absmiddle"/> <strong>Window Manager Error</strong><br>
		<hr>
		<p>An error has occured in the Window Manager. The affected application may not function as expected.</p>
		...
		<cfoutput> 
		<div style="width:100%; height:110px; overflow:auto;" class="__PREFINITI_DOCUMENT">
		...
		<div style="width:100%" align="right">
			<input type="button" class="normalButton" onclick="p_session.Framework.PostLocalMessage('WindowManagerError_#URL.wc#', IWC_REQUESTCLOSE, C_WINDOWMANAGER, null);" value="Close">
		</div>
		</cfoutput>	
	</div>
</div>