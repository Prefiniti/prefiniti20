...
<div style="width:100%; height:100%;" class="__PREFINITI_APPLICATION">
	<div style="padding:30px;">
		<img src="/graphics/pi-16x16.png" align="absmiddle"/> <strong>Framework Error</strong><br>
		<hr>
		<p>An error has occured in the Prefiniti Application Framework. The affected application may not function as expected.</p>
		...
		<div style="width:100%" align="right">
			<input type="button" class="normalButton" onclick="p_session.Framework.PostLocalMessage('FrameworkError_#URL.wc#', IWC_REQUESTCLOSE, C_WINDOWMANAGER, null);" value="Close">
		</div>
		</cfoutput>	
	</div>
</div>