<cffunction name="getSiteStats" returntype="struct" output="no">
    ...
    <cfquery name="Orders_1" datasource="#session.DB_Core#">
		SELECT * FROM orders WHERE vendor_id=#site_id# AND stage=1
	</cfquery>
    
    <cfquery name="Orders_2" datasource="#session.DB_Core#">
		SELECT * FROM orders WHERE vendor_id=#site_id# AND stage=2
	</cfquery>
    
    <cfquery name="Orders_3" datasource="#session.DB_Core#">
		SELECT * FROM orders WHERE vendor_id=#site_id# AND stage=3
	</cfquery>
    
    <cfquery name="Orders_4" datasource="#session.DB_Core#">
		SELECT * FROM orders WHERE vendor_id=#site_id# AND stage=4
	</cfquery>
    
    <cfquery name="Orders_5" datasource="#session.DB_Core#">
		SELECT * FROM orders WHERE vendor_id=#site_id# AND stage=5
	</cfquery>
    ...
    <cfset siteStats.orders1=#Orders_1.RecordCount#>
    <cfset siteStats.orders2=#Orders_2.RecordCount#>
    <cfset siteStats.orders3=#Orders_3.RecordCount#>
    <cfset siteStats.orders4=#Orders_4.RecordCount#>
    <cfset siteStats.orders5=#Orders_5.RecordCount#>
