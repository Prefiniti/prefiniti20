...
<cfoutput>
	...
	<cfif getPermissionByKey("CT_PROCESSPAYMENTS", attributes.QueriedAssociation)>
		<cfif s.orders0 GT 0>
			<img src="/graphics/AppIconResources/crystal_project/16x16/actions/project_open.png"  width="16" height="16"  align="absmiddle" onclick="window.open('https://us-production-r1g1s1.prefiniti.com/framework/OrderProcess/Master.cfm?VendorID=#URL.Current_Site_ID#&userid=#URL.CalledByUser#');" onmouseover="Tip('#s.orders0# unacknowledged orders');" onmouseout="UnTip();" />
		</cfif>	
		</cfif>
        
	<cfif getPermissionByKey("CT_PROCESSPAYMENTS", attributes.QueriedAssociation)>
		<cfif s.orders1 GT 0>
			<img src="/graphics/AppIconResources/crystal_project/16x16/actions/agt_update_recommended.png"  width="16" height="16"  align="absmiddle" onclick="window.open('https://us-production-r1g1s1.prefiniti.com/framework/OrderProcess/Master.cfm?VendorID=#URL.Current_Site_ID#&userid=#URL.CalledByUser#');" onmouseover="Tip('#s.orders1# acknowledged orders');" onmouseout="UnTip();" />
		</cfif>	
		</cfif>
        
		<cfif getPermissionByKey("CT_FULFILLORDERS", attributes.QueriedAssociation)>
		<cfif s.orders2 GT 0>
			<img src="/graphics/AppIconResources/crystal_project/16x16/actions/unfilled.png"  width="16" height="16"  align="absmiddle" onclick="window.open('https://us-production-r1g1s1.prefiniti.com/framework/OrderProcess/Master.cfm?VendorID=#URL.Current_Site_ID#&userid=#URL.CalledByUser#');" onmouseover="Tip('#s.orders2# unfilled orders');" onmouseout="UnTip();" />
		</cfif>	
		</cfif>
        
	<cfif getPermissionByKey("CT_FULFILLORDERS", attributes.QueriedAssociation)>
		<cfif s.orders3 GT 0>
			<img src="/graphics/AppIconResources/crystal_project/16x16/apps/ark.png"  width="16" height="16"  align="absmiddle" onclick="window.open('https://us-production-r1g1s1.prefiniti.com/framework/OrderProcess/Master.cfm?VendorID=#URL.Current_Site_ID#&userid=#URL.CalledByUser#');" onmouseover="Tip('#s.orders3# orders in process');" onmouseout="UnTip();" />
		</cfif>	
		</cfif>
        
	<cfif getPermissionByKey("CT_DELIVERORDERS", attributes.QueriedAssociation)>
		<cfif s.orders4 GT 0>
			<img src="/graphics/AppIconResources/crystal_project/16x16/actions/agt_add-to-autorun.png"  width="16" height="16"  align="absmiddle" onclick="window.open('https://us-production-r1g1s1.prefiniti.com/framework/OrderProcess/Master.cfm?VendorID=#URL.Current_Site_ID#&userid=#URL.CalledByUser#');" onmouseover="Tip('#s.orders4# orders awaiting delivery');" onmouseout="UnTip();" />
