...
Menu.prototype.Generate = function () {
	...
	for (i in this.Items) {
		...
		if (tItem.Caption != '-') {
			...
			this.HTML += '<tr><td style="background-color:white; color:black; font-size:12px; padding:4px; font-weight:bold;">&nbsp;</td><td style="background-color:white; color:black; font-size:12px; padding:4px; font-weight:bold;" align="center"><hr></td></tr>';
		}
