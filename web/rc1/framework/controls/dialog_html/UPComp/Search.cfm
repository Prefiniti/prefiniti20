<div style="background-color:white; width:100%; height:100%;">
    ...
    <table width="100%" cellspacing="0" cellpadding="5">
        ...
        <tr>
          <td colspan="2" align="left"><input type="button" class="normalButton" name="submit" value="Search" onclick="javascript:AjaxSubmitForm(AjaxGetElementReference('searchUsers'), '/socialnet/components/search_users_sub_20.cfm', 'UPFS_Target');"></td>
      </tr>      
    </table>
    </form>
	</div>
