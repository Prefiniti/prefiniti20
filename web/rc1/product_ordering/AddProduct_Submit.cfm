...
<cfoutput>
 	#CreateFolder(baseFldr, URL.ProductName, 20, 20, "/graphics/AppIconResources/crystal_project/32x32/actions/shopping_cart.png")#
    #CreateFolder(prodFldr, "Product Images", 20, 20, "/graphics/AppIconResources/crystal_project/32x32/actions/camera.png")#
